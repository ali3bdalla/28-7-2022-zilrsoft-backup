...
class CreateAmericanChartOfAccountsJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $departmemt = $this->organization->departments()->create([
            'branch_id' => $branch->id,
            'title' => 'الادارة',
            'ar_title' => 'management',
            'creator_id' => $supervisor->id,
        ...
        foreach ($users as $user) {
            $this->organization->users()->create(
                $user
            );
        }
...
//
    ...
    public function create_assets_accounting_accounts()
    {
        ...
        $this->organization->clients_chart_account_id = $clients->id; // add organization main client chart account
    ...
    public function create_liabitities_accounting_accounts()
    {
        ...
        $this->organization->vendors_chart_account_id = $vendor_chart->id; // add organization main vendors chart account
