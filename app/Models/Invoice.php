...
use Illuminate\Support\Facades\Storage;
    ...
    class Invoice extends BaseModel
    {
        ...
        public function getEncryptedPublicId()
        {
        ...
        {
            $publicIdElements = Invoice::getDescryptedPublicIdElements($hash);
        ...
        public static function getDescryptedPublicIdElements($hash): Collection
        {
