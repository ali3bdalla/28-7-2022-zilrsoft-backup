...
class CategoryController extends Controller
{
    ...
    public function index()
    {
       ...
       $categories =  Category::mainOnly()->with('children.children.children.children.children.children')->get();
...
//        return  $categories;
    ...
    public function update_filters(Category $category)
    {
        ...
        // return $cilfters;
        // return $category->load(['filters' => function ($q) {
        //    $q->orderBy('category_filters.created_at','asc');
        // }]);
        foreach ($cilfters as $key => $value) {
            $cat_filters[] =  collect($value)->forget('pivot');
        }
       // $cat_filters = $category->filters->forget(''));
