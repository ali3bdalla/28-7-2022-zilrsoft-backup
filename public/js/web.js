...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    isInArray: function isInArray(obj) {
    ...
    toggleSelectedAttributes: function toggleSelectedAttributes(value, attr) {
      var obj = this.getJsonObj(value, attr);
      this.isLoaded = false;

      if (this.isInArray(JSON.stringify(obj))) {
        var index = window.getIndex(JSON.stringify(obj), this.selectedAttributes);
