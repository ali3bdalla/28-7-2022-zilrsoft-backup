<template>
    <div class="box">
        ...
        <div class="">
            <div class="columns">
                <div class="column">
                    <button @click="push_to_server" class="button is-primary" v-show="can_submit_entry">حفظ</button>
                </div>
                <div class="column">
    ...
    export default {
        ...
        methods: {
            ...
            push_to_server() {
                ...
                axios.post("/management/transactions", data).then((response) => {
                    window.location = '/management/transactions';
                }).catch((error) => {
