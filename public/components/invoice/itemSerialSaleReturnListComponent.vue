<template>
    <div v-if="item.is_need_serial">
        ...
        <modal :id="'serialList_' + index" :name="'serialList_' + index" :scrollable="true" height="70%" width="70%">
            <div class="box">
                <div class="">
                    ...
                    <div class="columns">
                        ...
                        <div class="column">
                            <input :class="{'is-danger':errorMessage!=''}" @keyup.13="returnSerialNumber" class="input"
                                   placeholder="scan the serial to return it"
                                   ref="serial_field_ref2"
                                   type="text"
                ...
                <div class="box">
                    <table class="table table-bordered">
                        ...
                        <tr :key="index" v-for="(serial,index) in serials">
                            ...
                            <td>
                                    <span class="tag is-warning" v-show="serial.current_status=='available' ||
                                    serial.current_status=='r_sale'">
                                        returned
                                    </span>

                                <span class="tag is-success" v-show="serial.current_status=='saled'">
                                        available
                                    </span>

                                <span class="tag is-danger" v-show="serial.current_status=='r_purchase'">
                                        not available
                                    </span>
    ...
    export default {
        ...
        methods: {
            ...
            returnSerialNumber() {
                ...
                if (item == null) {
                ...
                } else if (item.current_status == 'r_sale' || item.current_status == 'available' ||
                    ...
                    item.current_status = 'r_sale';
                    this.serials.splice(index, 1, item);
                    this.serial_field = '';
                    this.errorMessage = '';
                    console.log('start calling update invoice..');
                    this.updateInvoice();
                }
            ...
            updateInvoice() {
                ...
                console.log('update invoice finished..')
