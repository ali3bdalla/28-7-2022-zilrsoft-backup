    ...
    <div class="content" style="padding: 22px;font-size: 22px">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <?php if($payment->is_belongs_to_invoice==1): ?>
                    <?php if( $payment->payment_invoices->count()>=2): ?>
                        <h5><?php echo e(__('pages/payments.payment_reason')); ?>  <?php echo e(__('pages/payments.payment_reason_2')); ?>
                    ...
                    <?php else: ?>
                        ...
                        <h5><?php echo e(__('pages/payments.payment_reason')); ?>  <?php echo e(__('pages/payments.payment_reason_' .
                    ...
                    <?php endif; ?>
                <?php else: ?>
                    <?php echo e(__('pages/payments.payment_reason')); ?>  <?php echo e(__('pages/payments.payment_reason_' .
                    $payment->is_belongs_to_invoice)); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h5><?php echo e(__('pages/payments.paid_by_' . $payment->payment_type)); ?> : <?php echo e($payment->gateway->name); ?></h5>
            </div>
        </div>
