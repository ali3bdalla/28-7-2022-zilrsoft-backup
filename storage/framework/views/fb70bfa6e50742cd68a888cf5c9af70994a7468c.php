...
<?php $__env->startSection('route',route('accounting.purchases.index')); ?>
            ...
            <div class="columns">
                <div class="column">
                    ...
                    <?php if($purchase->invoice_type=='purchase'): ?>
                        ...
                        <a href="<?php echo e(route('accounting.purchases.edit',$purchase->id)); ?>" class="button is-warning"><i
                                    class="fa
...
"><?php echo e($payment->paymentable->locale_name); ?> &nbsp;&nbsp; ( <a target="_blank" href="<?php echo e(route('accounting.payments.show',
