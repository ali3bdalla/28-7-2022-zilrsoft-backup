...
<?php $__env->startSection('buttons'); ?>
    <a href="<?php echo e(route('accounting.purchases.print',$invoice->id)); ?>" class="btn btn-default">
                ...
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <input type="text" name="" disabled="disabled"
                               class="form-control" value="<?php echo e($invoice->purchase->vendor->name); ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="input-group">
                        ...
                        <input type="text" disabled="disabled"
                               value="<?php echo e($invoice->purchase->vendor_inc_number); ?>"
                               class="form-control">
                    </div>
                </div>
                <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-group">
                        ...
                        <input type="text" name="" disabled="disabled"
                               class="form-control" value="<?php echo e($invoice->purchase->receiver->name); ?>">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="input-group">
...
<?php echo $__env->make('accounting.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/zilrsoft/resources/views/accounting/purchases/show.blade.php ENDPATH**/ ?>