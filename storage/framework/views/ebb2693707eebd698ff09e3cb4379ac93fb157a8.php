...
<?php $__env->startSection("content"); ?>
    <div class="panel panel-custom-form">
        <form method="post" action="<?php echo e(route('accounting.categories.update',$category->id)); ?>" class="panel-body">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?> ">
                        <input class="form-control arabic-input" name="ar_name"
                               value="<?php echo e(empty(old('ar_name')) ?  $category->ar_name :old('ar_name')); ?>"
...
unset($__errorArgs, $__bag); ?>">
                        <input class="form-control arabic-input" name="name"
                               value="<?php echo e(empty(old('name')) ?  $category->name :old('name')); ?>"
...
unset($__errorArgs, $__bag); ?>">
                        <textarea class="form-control" name="ar_description"
                                  placeholder="<?php echo e(trans('pages/categories.ar_description')); ?>"> <?php echo e(empty(old('ar_description')) ?  $category->ar_description :old('ar_description')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>">
                        <textarea class="form-control" name="description" placeholder="<?php echo e(trans('pages/categories.description')); ?>"><?php echo e(empty(old('description')) ?  $category->description :old('description')); ?></textarea>
                        ...
                        <select class="form-control" name="parent_id" placeholder="<?php echo e(trans('pages/categories.parent_id')); ?>">
                            ...
                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option
                                        ...
                                        selected
                                        <?php elseif($category->parent_id==$cat['id'] && empty(old('parent_id'))): ?>
                                        selected
                                        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>">
                        <toggle-button
                                :value="<?php echo e($category->is_available_online); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row">
                <div class="col-md-5 col-md-offset-1">
                    <button type="submit" class="btn btn-custom-primary"><?php echo e(trans('pages/categories.edit')); ?></button>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('accounting.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /usr/local/var/www/vhosts/zilrsoft/resources/views/accounting/categories/edit.blade.php ENDPATH**/ ?>