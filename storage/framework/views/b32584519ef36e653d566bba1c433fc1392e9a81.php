...
<html>
<head>
    <title><?php echo e($payment->id); ?></title>
...
<div class="">
    ...
    <div class="background_primary">
        <div class="row">
            ...
            <div class="col-md-6" style="float: left">
                <h3 style="color: white"><?php if($payment->payment_type=='receipt'): ?><?php echo e(__('pages/vouchers.receipt')); ?><?php else: ?><?php echo e(__('pages/vouchers.payment')); ?><?php endif; ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6" style="float: right">
                ...
                <div class="company-info">
                    <span><?php echo e(__('reusable.creator')); ?> : <?php echo e($payment->creator->locale_name); ?></span>
                </div>
                <div class="company-info">
                    <span><?php echo e(__('pages/invoice.phone_number')); ?> : <?php echo e($payment->creator->user->phone_number); ?></span>
                </div>
                <div class="company-info">
                    <span><?php echo e(__('pages/invoice.department')); ?> :  <?php echo e($payment->creator->department->locale_title); ?></span>
                </div>
    ...
    <div class="content" style="padding: 22px;font-size: 22px">
        <div class="row">
            ...
            <div class="col-md-6">
                <h5><?php echo e(__('pages/vouchers.payment_start_title_' . $payment->payment_type)); ?><?php echo e(__('pages/vouchers.voucher_user_' . $payment->user->user_title)); ?>


                    <?php echo e($payment->user->locale_name); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h5><?php echo e(__('pages/vouchers.amount_equ')); ?> <?php echo e($payment->amount); ?>
        ...
        <div class="row">
            ...
            <div class="col-md-6"></div>
            <div class="col-md-6">
                <h5><?php echo e(__('pages/vouchers.amount_in_words')); ?> <?php echo e($payment->amount_ar_words); ?> </h5>
            </div>
        ...
        <?php if(!empty($payment->paymentable->locale_name)): ?>
            <div class="row">
                ...
                <div class="col-md-12">
                    <h5><?php echo e(__('pages/vouchers.paid_by_' . $payment->payment_type)); ?>
        ...
        <?php if($payment->slug=='transfer' && $payment->payment_type=='payment'): ?>
            <div class="row">
                <div class="col-md-12">
                    <h5><?php echo e(__('pages/vouchers.user_account')); ?>
    ...
    <div class="">
        <div class="row" style="color: black !important;">
            ...
            <div class="issued_by">
                ...
                <p style="margin-bottom: 2px"><?php echo e($payment->creator->locale_name); ?></p>
...
<script>
    print();
</script><?php /**PATH /usr/local/var/www/workspace/zilrsoft/resources/views/accounting/printer/voucher.blade.php ENDPATH**/ ?>