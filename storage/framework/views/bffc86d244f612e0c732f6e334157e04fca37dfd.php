...
<?php $__env->startSection('buttons'); ?>
    ...
    <?php if($invoice->invoice_type=='quotation'): ?>
        <a href="<?php echo e(route('accounting.quotations.edit',$invoice->id)); ?>"  class="btn btn-default">
    ...
    <?php else: ?>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create sale')): ?>
            <a href="<?php echo e(route('accounting.sales.create')); ?>" class="btn btn-default"><i class="fa fa-plus-square"></i> <?php echo e(trans
...
<?php echo $__env->make('accounting.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /usr/local/var/www/workspace/zilrsoft/resources/views/accounting/sales/show.blade.php ENDPATH**/ ?>