...
<?php $__env->startSection("content"); ?>
    <div class="panel panel-custom-form">
        <form method="post" action="<?php echo e(route('accounting.filters.store')); ?>" class="panel-body">
            <?php echo csrf_field(); ?>
            <div class="row">
                <div class="col-md-6">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row">
                <div class="col-md-5 col-md-offset-1">
                    <button type="submit" class="btn btn-custom-primary"><?php echo e(trans('pages/filters.create')); ?></button>
                </div>
                <div class="col-md-2 col-md-offset-3">

                    <a href="<?php echo e(route('accounting.filters.index')); ?>" class="btn btn-custom-default"><?php echo e(trans
                        ('reusable.cancel')); ?></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('accounting.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/zilrsoft/resources/views/accounting/filters/create.blade.php ENDPATH**/ ?>