...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('template/css/pdf.css')); ?>">
    ...
    <div class="">
        ...
        <div class="row background_primary">
            ...
            <div class="col-md-6" style="float: left">
                ...
                <div class="company-info" style="margin-bottom: 10px">
                    <span><?php echo e($invoice->manager_type); ?> : <?php echo e($invoice->manager->locale_name); ?></span>
                </div>
        ...
        <div class="row" style="color: black !important;">
            ...
            <div class="issued_by">
                <?php if(auth()->user()->organization->stamp != null): ?>
                    <div style="margin-bottom: 9px"><img src="<?php echo e(auth()->user()->organization->stamp); ?>"
...
<?php /**PATH /private/var/www/workspace/zilrsoftproject/resources/views/accounting/printer/a4.blade.php ENDPATH**/ ?>