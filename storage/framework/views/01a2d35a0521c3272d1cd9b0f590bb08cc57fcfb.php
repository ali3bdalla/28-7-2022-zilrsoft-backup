...
<?php $__env->startSection('buttons'); ?>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create transaction')): ?>
        <a href="<?php echo e(route("entities.create")); ?>" class="btn btn-custom-primary"><i class='fa
                ...
                <?php $__currentLoopData = $entities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $entity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php $__currentLoopData = $entity->transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr style="border:none">
                            ...
                            <th><a href="<?php echo e(route('entities.show',$entity->id)); ?>"><?php echo e($entity->id); ?></a></th>
                            <th><?php echo e($transaction->description); ?></th>
                            ...
                            <?php if($transaction->type=="credit"): ?>
                                ...
                                ?>
                                <th></th>
                                <th><?php echo e(displayMoney($transaction['amount'])); ?></th>
                            <?php else: ?>
                                <?php
                    ...
                    <tr style="background-color: #eeeeee">
                        ...
                        <th><?php echo e(displayMoney($totalDebit)); ?></th>
                        <th><?php echo e(displayMoney($totalCredit)); ?></th>
                    </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </body>
            </table>
...
<?php echo $__env->make('accounting.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /private/var/www/workspace/zilrsoftproject/resources/views/accounting/transactions/index.blade.php ENDPATH**/ ?>