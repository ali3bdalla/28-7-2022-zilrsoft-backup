                    ...
                    <div class="filter_area">
                        <div class="input-group">
                            ...
                            <input placeholder="<?php echo e(__('pages/payments.type')); ?>" disabled
                                   value="<?php if($payment->is_belongs_to_invoice==1): ?><?php echo e(__('pages/payments.invoices_payment')); ?><?php else: ?><?php echo e(__('pages/payments.advance_payment')); ?><?php endif; ?>"
