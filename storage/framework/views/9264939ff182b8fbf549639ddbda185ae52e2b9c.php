<?php $__env->startSection('title',__('pages/branches.edit') . " | " . $branch->locale_name); ?>
...
<?php $__env->startSection("content"); ?>
    <div class="panel panel-custom-form">
        <form method="post" action="<?php echo e(route('accounting.branches.update',$branch->id)); ?>" class="panel-body">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                        <input class="form-control arabic-input" name="phone_number"
                               placeholder="<?php echo e(trans('pages/branches.phone_number')); ?>" value="<?php echo e(empty(old('phone_number')) ?
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="row">
                <div class="col-md-5 col-md-offset-1">
                    <button type="submit" class="btn btn-custom-primary"><?php echo e(trans('pages/branches.edit')); ?></button>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('accounting.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/zilrsoft/resources/views/accounting/branches/edit.blade.php ENDPATH**/ ?>