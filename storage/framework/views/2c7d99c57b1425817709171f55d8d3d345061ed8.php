<section class="sidebar" style=" margin-top: 50px;">
    <div class="user-panel">
        <img src="<?php echo e(auth()->user()->organization->logo); ?>" class="center-block img-responsive"
             alt="<?php echo e(auth()->user()->organization->title); ?>" width="100px" style="">
    </div>
    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view sale','create sale','edit sale','view purchase','create purchase','edit purchase'])): ?>
            <li class="treeview">
                <a href="#">
                    <i class="fab fa-product-hunt"></i> <span> <?php echo e(__('sidebar.management')); ?>
                ...
                <ul class="treeview-menu">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage quotation')): ?>
                        <li>
                            <a href="<?php echo e(route('accounting.sales.quotations')); ?>"><i class="fa fa-sun"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('manage inventory')): ?>
                        ...
                        <li>
                            <a href="<?php echo e(route('accounting.inventories.index')); ?>"><i class="fa fa-sun"></i>
                                <?php echo e(__('sidebar.adjust_stock')); ?>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view voucher')): ?>
                        <li>
                            <a href="<?php echo e(route('accounting.payments.index')); ?>"><i class="fab fa-product-hunt"></i>
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create voucher')): ?>
                        <li>
                            <a href="<?php echo e(route('accounting.filters.index')); ?>"><i class="fa fa-sun"></i>
                                <?php echo e(__('pages/payments.create_payment')); ?>

                            </a></li>

                        <li>
                            <a href="<?php echo e(route('accounting.filters.index')); ?>"><i class="fa fa-sun"></i>
                                <?php echo e(__('pages/payments.create_receipt')); ?>
        ...
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->any(['view identities','create identity','manage managers'])): ?>
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view identities')): ?>
                        <li>
...
<?php /**PATH /home/vagrant/code/zilrsoft/resources/views/accounting/layout/head/sidebar.blade.php ENDPATH**/ ?>