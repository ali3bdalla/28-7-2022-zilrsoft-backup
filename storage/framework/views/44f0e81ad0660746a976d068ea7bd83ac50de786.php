<?php $__env->startSection('title','الحسابات المالية للمنشأة'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="box">
        ...
        <div class="card-body">
            <a href="<?php echo e(route('management.settings.payments_account_create')); ?>" class="button is-info pull-right"><i class='fa
                fa-plus-circle'></i>&nbsp; <?php echo e(__('pages/settings.payments_create')); ?></a>
...
<?php echo $__env->make('layouts.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /usr/local/var/www/resources/views/settings/payment_accounts.blade.php ENDPATH**/ ?>