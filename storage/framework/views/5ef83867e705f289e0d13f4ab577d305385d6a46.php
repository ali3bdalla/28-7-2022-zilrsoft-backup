			 ...
			 <?php $balance = 0;?>
                <?php $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <tr>
                        ...
                        <th class="text-center "><?php if(!empty($transaction->invoice)): ?><a href="<?php echo e(route('accounting.purchases.show',
                        $transaction->invoice->id)); ?>"><?php echo e($transaction->invoice->title); ?></a><?php endif; ?></th>
...
<?php echo $__env->make('accounting.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /usr/local/var/www/workspace/zilrsoft/resources/views/accounting/charts/transactions/vendor.blade.php ENDPATH**/ ?>