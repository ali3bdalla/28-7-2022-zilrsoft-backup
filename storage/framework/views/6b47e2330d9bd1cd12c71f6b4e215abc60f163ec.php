                        ...
                        <?php $__currentLoopData = $item->item->serials()
                            ...
                            <tr>
                                <td style="padding-right:10px;text-align: right"
                                    colspan="<?php if($invoice->show_items_price_in_print_mode): ?> 6 <?php else: ?> 2 <?php endif; ?>">
    ...
    <div class="row">
        ...
        <div class="col-xs-12">
            <div class="header_title">
                ...
                <span class="pull-left"> <span> <?php echo e(money_format('%i ريال',$invoice->net )); ?></span></span>
            </div>
        </div>
...
<script>
    $("#barcode_demo").barcode(
        "<?php echo e($invoice->invoice_number); ?>",// Value barcode (dependent on the type of barcode)
...
<?php /**PATH /usr/local/var/www/workspace/zilrsoft/resources/views/accounting/printer/receipt.blade.php ENDPATH**/ ?>