            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view charts')): ?>
                        ...
                        <li>
                            <a href="<?php echo e(route('accounting.financial_statements.index')); ?>"><i class="fa fa-sun"></i>
...
<?php /**PATH /usr/local/var/www/vhosts/zilrsoft/resources/views/accounting/layout/head/sidebar.blade.php ENDPATH**/ ?>