    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li>
                    <a href="<?php echo e(route('store.orders.index')); ?>"><i class="fa fa-sun"></i>
                        الطلبات
                    </a>
                </li>
                ...
                <li>
                    <a href="<?php echo e(route('store.shipping.index')); ?>"><i class="fa fa-sun"></i>
                        الشحن
                    </a>
                </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create voucher')): ?>
                        ...
                        <?php if($loggedManager['organization_id'] == 1): ?>
                            <li>
                                <a href="<?php echo e(route('vouchers.create.supplier')); ?>"><i class="fa
                            fa-sun"></i>
                                    اضافة سند مصاريف
                                </a></li>
                        <?php endif; ?>
...
<?php /**PATH /private/var/www/workspace/zilrsoftproject/resources/views/accounting/layout/head/sidebar.blade.php ENDPATH**/ ?>