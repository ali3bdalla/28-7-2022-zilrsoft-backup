    ...
    <tr style="border:none">
        ...
        <?php if($index==0): ?>
            ...
            <th width="20%" style="vertical-align: inherit;" rowspan="<?php echo e(count
                                ($invoice_transactions)); ?>"><a href="<?php echo e(route('management.purchases.show',$purchase->id)); ?>"><?php echo e($purchase->invoice->title); ?></a></th>
            <th width="10%" style="vertical-align: inherit;"
                rowspan="<?php echo e(count($invoice_transactions)); ?>"><a href="<?php echo e(route('management.transactions.show',$transaction->id)); ?>"><?php echo e($invoice_transaction['id']); ?></a></th>
