...
<?php $__env->startSection('content'); ?>
    <accounting-sales-create-component
            ...
            :creator='<?php echo json_encode(auth()->user()->with('department', 'branch', 'user')->first()) ?>'
    ></accounting-sales-create-component>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('accounting.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/zilrsoft/resources/views/accounting/sales/create.blade.php ENDPATH**/ ?>