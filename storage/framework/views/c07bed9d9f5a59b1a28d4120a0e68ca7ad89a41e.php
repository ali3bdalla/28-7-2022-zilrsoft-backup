...
<?php $__env->startSection('content'); ?>
    <div class="">
        <div class="row">
            <div class="col-md-12">
                <create-quotation-form-component :salesmen='<?php echo json_encode($salesmen, 15, 512) ?>' :gateways='<?php echo json_encode($gateways, 15, 512) ?>'
...
<?php echo $__env->make('layouts.master2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/zilrsoft/resources/views/sales/quotation_create.blade.php ENDPATH**/ ?>