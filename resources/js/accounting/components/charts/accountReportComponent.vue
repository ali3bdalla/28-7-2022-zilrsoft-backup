    ...
    <div>
        <div class="panel">
            <div class="panel-heading">
                ...
                <div class="row">
                    <div
                            class="col-md-4"><div class="well"> المدين  :<span
                            class="lead">{{parseFloat(totalDebit).toFixed(2)
                        }}</span>
                    </div></div>
                    <div class="col-md-4"><div class="well"> الدائن  :<span class="lead">{{parseFloat(totalCredit).toFixed(2) }}</span> </div></div>
                    <div class="col-md-4"><div class="well"> المجموع  :<span class="lead">{{parseFloat(totalAmount).toFixed(2)}}</span>
                    </div></div>
        ...
        methods: {
            ...
            loadData() {
                if (this.account != null && this.startDate != null && this.endDate != null) {
                    ...
                    axios.get("/accounting/accounts/reports/" + this.account.id + "/result", {
                        params: params
                    }).then(response => {
