    ...
    <div class="box">
      ...
      <div v-if="payment_type == 'payment'">
        ...
        <div class="row">
          ...
          <div
            class="col-md-6"
            v-if="user_accounts.length >= 1 && voucher_type == 'transfer'"
          >
            <accounting-select-with-search-layout-component
              :no_all_option="true"
      ...
      <div class="row" v-if="!error">
        <div class="col-md-12">
          <div class="form-group">
            <button @click="sendToServer" class="btn btn-custom-primary">
              حفظ
            </button>
          </div>
        </div>
...
export default {
  ...
  methods: {
    ...
    validator() {
      ...
      if (
        this.voucher_type == "" ||
        parseFloat(this.total_paid_amount) <= 0 ||
    ...
    sendToServer() {
      ...
      axios
        ...
        .catch(function (error) {
          alert("البيانات المدخلة غير كافية للعملية");
          // console.log(error);
