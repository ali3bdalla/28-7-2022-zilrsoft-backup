      ...
      <div class="table-filters">
        ...
        <div v-show="isOpenSearchPanel">
          <div class="row">
            ...
            <div class="col-md-1">
              <select v-model="filters.payment_type" class="form-control" @change="pushServerRequest">
            ...
            <div class="col-md-2">
              <input v-model="filters.amount" :placeholder="app.trans.amount"
                     class="form-control"
                     type="text" @keyup="pushServerRequest">
            </div>
            <div class="col-md-2">
              <input v-model="filters.id" :placeholder="app.trans.number"
                     class="form-control"
                     type="text" @keyup="pushServerRequest">
            </div>
      ...
      <div v-show="!isLoading" class="table-content">
        <table class="table table-striped table-bordered" width="100%">
          ...
          <tr>
            ...
            <th :class="{'orderBy':orderBy=='user_id'}" width=""
                @click="setOrderByColumn('user_id')">
              {{ app.trans.client }}
            </th>
            ...
            <th :class="{'orderBy':orderBy=='amount'}" width=""
                @click="setOrderByColumn('amount')">
              {{ app.trans.amount }}
            </th>
          ...
          <tr v-for="(row,index) in table_rows" :key="row.id">
            ...
            <td v-if="row.payment_type==='receipt'" class="text-center" v-text="app.trans.receipt"></td>
            <td v-else class="text-center" v-text="app.trans.payment"></td>
