<template>
    <div class="row">
        <div class="col-md-3" v-for="(attachment,index) in attachments_list" :key="attachment.id">
        ...
        <div class="col-md-3">
            <attachment-uploader-component :upload_link="new_attachment_link"
                                           @uploaded="attachmentsUploaded"></attachment-uploader-component>
        </div>
    </div>
</template>
