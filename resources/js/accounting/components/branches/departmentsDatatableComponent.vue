            ...
            <div class="table-content " v-show="!isLoading">
                <table class="table table-striped table-bordered" width="100%">
                    ...
                    <tr :key="row.id" v-for="(row,index) in table_rows">
                        ...
                        <td class="text-center" v-text="row.ar_title"></td>
                        ...
                        <td>
                            ...
                            <div class="dropdown">
                                ...
                                + row.id" class="dropdown-menu CustomDropDownOptions">
                                    <li v-if="canEdit==1"><a :href="baseUrl+branch.id+'/departments/'+ row.id +'/edit'"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            initUi() {
                this.requestUrl = this.app.datatableBaseUrl + 'branches/' + this.branch.id + '/departments';
            ...
            deleteItemClicked(department) {
                ...
                this.$dialog
                    ...
                    .then(dialog => {
                        ...
                        axios.delete(appVm.app.BaseApiUrl + 'branches/' + this.branch.id + '/departments/' +
                            department.id)
                            .then(function (response) {
