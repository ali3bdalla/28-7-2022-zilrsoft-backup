            ...
            <div class="table-content " v-show="!isLoading">
                <table class="table table-striped table-bordered" width="100%">
                    ...
                    <tr>
                        ...
                        <th :class="{'orderBy':orderBy=='phone_number'}" @click="setOrderByColumn('phone_number')">
                            {{ app.trans.phone_number }}
                        </th>
                    ...
                    <tr :key="row.id" v-for="(row,index) in table_rows">
                        ...
                        <td class="text-center" v-text="row.phone_number"></td>
                        ...
                        <td>
                            ...
                            <div class="dropdown">
                                ...
                                + row.id" class="dropdown-menu CustomDropDownOptions">
                                    ...
                                    <li><a :href="baseUrl + row.id + '/departments'"
                                           v-text="app.trans.departments"></a></li>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            initUi() {
                this.requestUrl = this.app.datatableBaseUrl + 'branches';
            ...
            deleteItemClicked(branch) {
                ...
                this.$dialog
                    ...
                    .then(dialog => {
                        ...
                        axios.delete(appVm.app.BaseApiUrl + "branches/" + branch.id)
                            .then(function (response) {
