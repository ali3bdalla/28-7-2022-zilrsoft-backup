<template>
  ...
  <div class="message">
    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <alice-name-form-pop
          @updated="(e) => (invoiceData.aliceName = e.alice_name)"
        ></alice-name-form-pop>
      ...
      <div class="col-md-4">
        <div class="input-group">
          <span class="input-group-addon">رقم الجوال</span>
          <input
            v-model="invoiceData.contact_phone_number"
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <accounting-select-with-search-layout-component
          :default-index="creator.department_id"
          :no_all_option="true"
          :options="departments"
          ...
          @valueUpdated="departmentChanged"
        >
        </accounting-select-with-search-layout-component>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    handleCloningEvent() {
      ...
      this.invoiceData.department_id = this.quotation.department_id;
    ...
    departmentChanged(event) {
      this.invoiceData.department_id = event.value.id;
    },
    ...
    enableSaveButton() {
      this.everythingFineToSave = true;
    },
    ...
    pushDataToServer(doWork = null) {
      ...
      if (client.is_system_user) {
        if (
          (this.invoiceData.contact_phone_number == null ||
            this.invoiceData.contact_phone_number == "") &&
          (client.mobile == null || client.mobile == "")
        ) {
          alert("يجب ادخال رقم تواصل في حالة العميل النقدي");
          return;
        }
      ...
      const data = {
        ...
        contact_phone_number: "966" + this.invoiceData.contact_phone_number,
        ...
        department_id: this.invoiceData.department_id,
