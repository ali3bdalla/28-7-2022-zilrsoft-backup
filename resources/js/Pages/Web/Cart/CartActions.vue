<template>
  <div class="cart__totals-buttons">
    <div class="cart__total-amount">
      ...
      <div>
        <display-money :money="getOrderTotalAmount()"></display-money>
        {{ $page.$t.products.sar }}
      </div>
    </div>
    <div class="cart__total-amount">
      ...
      <div>
        <display-money :money="shippingWeight"></display-money>
        {{ $page.$t.products.kg }}
      </div>
    </div>
    <div v-if="shippingMethodId">
      <div class="cart__total-amount">
        ...
        <div v-if="shippingSubtotal > 0">
          <display-money :money="shippingSubtotal"></display-money>
        </div>
      ...
      <div class="cart__total-amount">
        ...
        <div>
          <display-money :money="orderNetAmount"></display-money>
          {{ $page.$t.products.sar }}
        </div>
      </div>
