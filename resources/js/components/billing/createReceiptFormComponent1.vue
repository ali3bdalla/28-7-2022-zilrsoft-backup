        ...
        <div class="box">
            ...
            <div class="columns">
                ...
                <custom-select-component
                        ...
                        identity="1"
                        :placeholder="translator.select_client"
                        :title="translator.client"
                       >
                </custom-select-component>
                ...
                <div class="column" v-if="voucherType_id==1">
                    <div class="filter_area">
                        <div class="input-group">
                            <span class="input-group-addon has-background-primary has-text-white">{{ translator.amount
                                }}</span>
                            <input
        ...
        methods: {
            ...
            * */
            voucherTypesListUpdated(e) {
                // this.user_id = this.clients[0].id;
