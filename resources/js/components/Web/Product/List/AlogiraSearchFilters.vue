<template>
  <div>
    ...
    >
      <!-- style="overflow-y: scroll; height: 100vh !important" -->
      <div class="w-full">
      <!-- <div > -->
      <!-- class="container-fluid filters-layout-modal" -->
            ...
            <div class="fw-brand-check">
              ...
              <div class="" v-for="item in items" :key="item.value">
                ...
                /> -->
                  ...
                  <span :class="[item.isRefined ? 'bg-gray-200 px-2 py-1' : '']"
                    ><ais-highlight attribute="item" :hit="item" /> ({{
                      item.count.toLocaleString()
                    }})</span
                  >
...
export default {
  data: function () {
    return {
      selectedFilters: [],
      isFilterLayoutOpen: true
    }
  },

  created () {
    this.showFiltersLayout()
  },
  methods: {
