...
<!--                    </div>-->
                    ...
                    <div class="column">
                        <div class="field">
                            <div class="control">
                                <input
                                        disabled
                                        :class="{'is-danger':error=='sales_price'}"
                    ...
                    <div class="column">
                        <div class="field">
                            <div class="control">
                                <input
                                        disabled
                                        :class="{'is-danger':error=='sales_inc_price'}"
            ...
            <div class="columns">
                <div class="column">
                    <toggle-button
                            disabled
                            :font-size="14" :height='30' :labels="{checked: reusable_translator.radio_checked,
                ...
                <div class="column">
                    <div class="field">
                        <div class="control">
                            <input
                                    disabled
                                    :placeholder="translator.vat_sale" @keydown="vatSaleInputUpdated" class="input"
                                   type='text'
                                   v-model="vat_sale">
                        </div>
                ...
                <div class="column">
                    <div class="field">
                        <div class="control">
                            <input
                                    disabled
                                    :placeholder="translator.vat_purchase" @keydown="vatPurchaseInputUpdated"
                                   class="input"
                                   type='text'
            ...
            <div class="columns">
                ...
                <div class="column is-three-fifths">
                    <div :dir="rtl ? 'rtl' : 'ltr'">
                        ...
                        <input type="text" class="input" :value="itemCategory.locale_name" disabled>
                    </div>
            ...
            <div v-bind:key="index" v-for='(filter,index) in filterList'>
                <filter-select-with-search-component
                        ...
                        :filter="filter"
                        :index="index"
                        :messages="messages" :options="filter.values"
                        :reusable_translator="reusable_translator" :translator="translator"
...
<script>
    ...
    export default {
        ...
        props: ["item", "itemFilters", 'itemCategory'],
        data: function () {
            return {
