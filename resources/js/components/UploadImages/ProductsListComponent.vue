    ...
    <table class="table table-light text-center table-bordered">
      <thead>
        <tr>
          ...
          <td
            class="text-center btn cursor-pointer"
            scope="col"
            @click="filterByModel"
          >
      ...
      <tbody>
        ...
        >
          ...
          <td>
            <a
              :href="`https://www.google.com/search?q=${product.barcode}&safe=strict&source=lnms&tbm=isch&sa=X&tbs=isz:m`"
              target="_blank"
              >{{ product.barcode }}</a
            >
          </td>
          <td>
            ...
            <br />
            <a
              :href="`https://www.google.com/search?q=${product.ar_name}&safe=strict&source=lnms&tbm=isch&sa=X&tbs=isz:m`"
              target="_blank"
              >{{ product.ar_name }}</a
            >
          </td>
          ...
          <td>
            <a
              :href="`https://www.google.com/search?q=${product.model_name}&safe=strict&source=lnms&tbm=isch&sa=X&tbs=isz:m`"
              target="_blank"
              >{{ product.model_name }}</a
            >
            <br />
            <a
              :href="`https://www.google.com/search?q=${product.model_ar_name}&safe=strict&source=lnms&tbm=isch&sa=X&tbs=isz:m`"
              target="_blank"
              >{{ product.model_ar_name }}</a
            >
          </td>
