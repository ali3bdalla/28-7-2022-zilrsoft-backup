                ...
                <div class="row">
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <div
                        v-if="
                          $page.props.errors && $page.props.errors.first_name
                        "
                  ...
                  <div class="col-lg-6">
                    <div class="form-group">
                      ...
                      <div
                        v-if="
                          $page.props.errors && $page.props.errors.last_name
                        "
                        class="p-2 text-red-500"
                      >
                  ...
                  <div class="col-lg-6">
                    <div class="form-group page__dir-left">
                      ...
                      <div
                        v-if="
                          $page.props.errors && $page.props.errors.phone_number
                        "
                        class="p-2 text-red-500"
                      >
...
export default {
  ...
  created() {
    const cityId = this.$page.props.cart.city_id;
    const cityObject = this.$page.props.cart.city;
    if (cityObject) {
