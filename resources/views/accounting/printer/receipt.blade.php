...
<link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-rtl/3.4.0/css/bootstrap-rtl.css" rel="stylesheet" id="bootstrap-css">
...
<div class="container-fluid" id="container">
    <div class="raw">
        ...
        <div class="col-xs-12">
            @if($invoice->invoice_type == "warranty_tracing")
            <div align="center" style="font-size: 27px !important;">سند تتبع الضمان</div>
            @else
    ...
    <div class="row">wb
        ...
        <div class="col-xs-6 text-left">
            {{ $invoice->user_alice_name == "" ? $invoice->user->locale_name :$invoice->user_alice_name   }}
        </div>
    </div>
        ...
        <div class="col-xs-12">
            <table class="table" style="margin-right: 3px;border:none !important;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="padding-right:10px;text-align: right" colspan="@if($invoice->show_items_price_in_print_mode) 6 @else 2 @endif">
