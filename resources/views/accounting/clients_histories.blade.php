			 ...
			 ?>
                @foreach($clients as $history)
                     ...
                     <tr>
                         ...
                         <th class="text-center ">{{ money_format("%i",$history->total_debit )}}</th>
                         <th class="text-center ">{{money_format("%i",$history->total_credit)  }}</th>
                         <th class="text-center ">{{ money_format("%i",$history->total_debit - $history->total_credit)  }}</th>
