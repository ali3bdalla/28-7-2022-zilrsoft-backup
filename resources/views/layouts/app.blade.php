            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto" id='navbar-list'>
                        ...
                        @guest
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('management.login') }}">{{ __('Login') }}</a>
                            </li>
                            @if (Route::has('management.register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('management.register') }}">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('management.logout') }}"
                        ...
                        <div class="col-md-10">
                            <div class="card alert-danger">
                                <div class="card-body">
                                    ...
                                    {{ __('If you did not receive the email') }}, {{ Auth::user()->email  }} <a href="{{ route('management.verification.resend') }}">{{ __('click here to request another') }} </a>.
                                </div>
                            </div>
                        </div>
                    </div>
