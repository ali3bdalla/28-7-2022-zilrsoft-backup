        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto" id='navbar-list'>
                    ...
                    @guest
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('accounting.login') }}">{{ __('Login') }}</a>
                        </li>
                        @if (Route::has('accounting.register'))
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('accounting.register') }}">{{ __('Register') }}</a>
                            </li>
                        @endif
                    @else
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                ...
                                <form id="logout-form" action="{{ route('accounting.logout') }}" method="POST"
                                      style="display: none;">
                                    @csrf
                                </form>
                            </div>
                        ...
                        <div class="col-md-10">
                            <div class="card alert-danger">
                                <div class="card-body">
                                    ...
                                    {{ __('If you did not receive the email') }}, {{ Auth::user()->email  }} <a
                                            href="{{ route('accounting.verification.resend') }}">{{ __('click here to request another') }} </a>.
                                </div>
                            </div>
                        </div>
                    </div>
