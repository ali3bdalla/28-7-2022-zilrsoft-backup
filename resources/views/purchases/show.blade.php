            ...
            <div class="columns">
                <div class="column">
                    ...
                    @if($purchase->invoice_type=='purchase')
                        {{--                        <a href="{{ route('management.purchases.clone',$purchase->id) }}" class="button is-primary"><i--}}
                        {{--                                    class="fa fa-copy"></i>&nbsp; {{ __('pages/invoice.clone')--}}
                        {{--                        }}</a>&nbsp;--}}
                        <a href="{{ route('management.purchases.edit',$purchase->id) }}" class="button is-warning"><i
                                    class="fa
