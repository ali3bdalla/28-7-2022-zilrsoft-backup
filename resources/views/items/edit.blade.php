        ...
        <div class="row">
            <div class="col-md-12">
                <article class="message  is-info">
                    @if($isClone)
                        <new-item-form-component :categories='@json($categories)' :is-cloned="true" :item="{{$item}}" :item-filters='@json($item->filters)' :item-category='@json($item->category)'></new-item-form-component>
                    @else
